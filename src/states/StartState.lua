...
function StartState:render()
    ...
    love.graphics.rectangle('fill', VIRTUAL_WIDTH / 2 - 220, VIRTUAL_HEIGHT / 2 - 40,
        440, 108, 50)
    
    love.graphics.setColor(200, 200, 200, 255)
    love.graphics.setFont(gFonts['large'])
    love.graphics.printf('Angry Birds by Group 8', 0, VIRTUAL_HEIGHT / 2 - 25, VIRTUAL_WIDTH, 'center')
